...
void	DiamondTrap::whoAmI()
{
	if (this->getHp() <= 0)
	{
		std::cout << "🪦 you reach a tomb. You walk towards it and read : ' Here lies " << this->getName() << " beloved DiamondTrap💎 and husband, born known as " << ClapTrap::getName() << " ' and we will always remember him. " << std::endl;
	...
	else
	{
		...
		std::cout << "This DiamondTrap answers: " << GREEN << "\n \t'An eternity would not be enough to tell you who I am, but others call me " << this->getName() << " and if you ask for my ancestors' name, it is " << ClapTrap::getName() << " Hope this helps. '" << RESET << "\n What a kind being." << std::endl;
	}
}
